...
export function AppSideBar({isOpen, shouldShowCard, setShouldShowCard}: {isOpen:boolean, setIsOpen:(open: boolean) => void, shouldShowCard: boolean, setShouldShowCard: (show: boolean) => void}) {
